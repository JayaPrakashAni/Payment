...
import { View, Text, ImageBackground, ActivityIndicator, ScrollView, StyleSheet, Image } from "react-native";

const BCGuitar = ({ }) => {
  const [dataArray, setDataArray] = useState([]);
  const [isLoaded, setIsLoaded] = useState(false);
  const imagebackground = require('../Images/background/blackbg.jpeg');
